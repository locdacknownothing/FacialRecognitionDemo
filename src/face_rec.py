...
def main():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out = cv2.VideoWriter(
                "app/static/processed_video.avi", fourcc, fps, (frame_width, frame_height))
        ...
        # Convert avi to mp4
        avi_file = VideoFileClip('app/static/processed_video.avi')
        avi_file.write_videofile('app/static/processed_video.mp4', codec='libx264')
